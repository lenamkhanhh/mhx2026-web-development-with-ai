...
describe("TripFlow App composition",()=>{
 ...
 it("shows the proof-backed English join-by-code path",async()=>{await render(<App backend={backend(user,null,[])}/>);expect(screen.getByRole("region",{name:"Join by code"})).toBeTruthy();expect(screen.getByRole("button",{name:"Join trip"})).toBeTruthy();});
